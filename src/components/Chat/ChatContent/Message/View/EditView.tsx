  ...
  return (
    <>
      ...
      >
        <textarea
          ref={textareaRef}
          className="m-0 resize-none rounded-lg bg-transparent overflow-y-hidden focus:ring-0 focus-visible:ring-0 leading-7 w-full text-white placeholder:text-gray-300/40"
          onChange={(e) => {
