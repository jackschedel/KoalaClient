...
const ModelConfigBar = React.memo(() => {
  ...
  return config
    ? (
      <>
        <div className="sticky p-1 pb-0.5  mb-19 top-0 flex gap-x-3 gap-y-1 flex-wrap w-full items-center justify-center border-b border-black/20 bg-gray-50/80 dark:border-gray-900 dark:bg-gray-700/80 text-gray-800 dark:text-white z-50">
          {advancedMode &&
            (
              <div className="sticky top-0 flex gap-x-3 gap-y-1 flex-wrap w-full items-center justify-center p-1 pb-0">
                ...
                <div
                  className="text-center p-1.5 opacity-100 rounded-md bg-gray-300/90 dark:bg-gray-800/90 hover:bg-gray-300 dark:hover:bg-gray-900 cursor-pointer"
                  onClick={() => {
                    setIsModalOpen(true);
                  }}
                >
                ...
                <div
                  className="text-center p-1.5 rounded-md bg-gray-300/90 dark:bg-gray-800/90 hover:bg-gray-300/90 dark:hover:bg-gray-900 cursor-pointer"
                  onClick={() => {
                    setIsModalOpen(true);
                  }}
                >
                ...
                <div
                  className="text-center p-1.5 rounded-md bg-gray-300/90 dark:bg-gray-800/90 hover:bg-gray-300 dark:hover:bg-gray-900 cursor-pointer"
                  onClick={() => {
                    setIsModalOpen(true);
                  }}
                >
