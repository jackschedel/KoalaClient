...
const GooglePopup = ({
  ...
  return (
    <PopupModal
      ...
      cancelButton={false}
    >
      <div className='p-6 text-custom-white text-sm flex flex-col items-center gap-4 text-center'>
        <p>{t('tagline')}</p>
        <GoogleSyncButton
          loginHandler={() => {
        ...
        />
        <p className='border border-custom-white/20 px-3 py-2 rounded-md'>
          {t('notice')}
        </p>
...
const FileSelector = ({
  ...
  return (
    <label
      className={`w-full flex items-center justify-between mb-2 gap-2 text-sm font-medium text-custom-white ${
