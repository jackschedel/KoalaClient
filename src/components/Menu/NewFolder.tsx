...
const NewFolder = () => {
  ...
  return (
    <a
      className={`flex py-3 px-3 items-center gap-3 rounded-md hover:bg-neutral-light transition-colors duration-200 text-white text-sm mb-2 flex-shrink-0 border border-white/20 transition-opacity ${
        generating
