...
const Menu = () => {
  ...
  return (
    <>
      <div
        id='menu'
        className={`group/menu dark bg-neutral-dark fixed md:inset-y-0 md:flex md:w-[260px] md:flex-col transition-transform z-[999] top-0 left-0 h-full max-md:w-3/4 ${
